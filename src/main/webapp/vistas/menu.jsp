                        ...
                        <div class="container">
                            ...
                            <div class="menu-grid">
                                ...
                                <%-- MÓDULO 1: CONTROL DE USUARIOS (Corregido: Administrador es idTipo==1 en tu BD) --%>
                                    <c:if
                                        test="${sessionScope.usuarioLogueado.idTipo == 1 || fn:containsIgnoreCase(sessionScope.usuarioLogueado.nombreRol, 'Administrador')}">
                                        <div class="menu-card" style="border-color: #dc3545;">
                                            <h3 style="color: #dc3545;">Gestión de Usuarios</h3>
                                            <p>Módulo de Control Técnico: Altas, bajas, ediciones y restablecimiento de
                                                contraseñas del sistema.</p>
                                            <a href="${pageContext.request.contextPath}/usuarios?accion=listar"
                                                class="btn-enter" style="background-color: #dc3545;">Administrar</a>
                                        </div>
                                    </c:if>
                                            ...
                                            <%-- MÓDULO 3: PRÉSTAMOS Y DEVOLUCIONES --%>
                                                <div class="menu-card">
                                                    ...
                                                    <a href="${pageContext.request.contextPath}/Prestamos?accion=listar"
                                                        class="btn-enter"
                                                        style="background-color: #28a745;">Ingresar</a>
                                                </div>

                                                <%-- MÓDULO 4: CONFIGURACIÓN DE MORA --%>
                                                    <div class="menu-card">
                                                        <h3 style="color: #6c757d;">Configuración de Mora</h3>
                                                        <p>Gestión operativa de mora por año y ajustes de tasas
                                                            paramétricas.</p>
